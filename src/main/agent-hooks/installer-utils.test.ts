...
describe('wrapWindowsCmdHookCommand', () => {
  ...
  it('resolves the launcher to a real executable file, not a shell fragment', () => {
    // Regression guard for #8430: Codex/Antigravity/Devin spawn the launcher as a
    // program (argv[0]), so it must be an existing, launchable file. The broken
